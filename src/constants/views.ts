...
export const PAGE_TITLES: Record<string, string> = {
  ...
  [APP_PATHS.admin]: 'ผู้ดูแลระบบ',
  [APP_PATHS.adminDocuments]: 'ทะเบียนรับ-ส่งเอกสาร',
  [APP_PATHS.adminDocTypes]: 'ประเภทเอกสาร',
  [APP_PATHS.adminUsers]: 'จัดการบุคลากร',
